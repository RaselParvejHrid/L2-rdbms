...
LIMIT ও OFFSET ক্লজের ব্যবহারটা সবচেয়ে পরিষ্কার বুঝা যায় এদের একটি ব্যবহারিক প্রয়োগ থেকে।

হ্যাঁ, সে ব্যবহারিক প্রয়োগ হলো Pagination।

ধরুন, আপনার ডাটাবেসে 53টা মুভির ডাটা আছে।

ডাটাবেসে সংশ্লিষ্ট টেবিলের নাম movies। এই টেবিলের 53টা রো। প্রতিটি রো একেকটি মুভির তথ্য।

এখন আপনার ফ্রন্টেন্ড এ্যাপে আপনি কিন্তু একই সাথে 53টা মুভি দেখাবেন না। বরং, ভালো প্র্যাক্টিস হলো এই মুভির তথ্যগুলো পেজ করে দেখানো। প্রতি পেজে সর্বোচ্চ 10টা, 15টা বা 20টা, মুভি কার্ডের সাইজের ওপর নির্ভর করে।

ধরলাম, সর্বোচ্চ 20টা করে দেখাবেন।

তাহলে প্রথম পেজে দেখাবেন মুভি-১ থেকে শুরু করে ২০টা মুভি। একজন ইউজার অন্য পেজগুলো নাও দেখতে চাইতে পারে। ব্যাকএন্ড বা ডাটাবেসে সব মুভির ডাটার জন্য কল করা বুদ্ধিমানের কাজ না। মুভি-১ থেকে শুরু করে সর্বোচ্চ ২০টা মুভির জন্য কল করবেন। পাবেন মুভি-১ থেকে মুভি-২০।

ইউজার ২য় পেজে গেলে তখন আবার ডাটাবেস থেকে লোড করবেন মুভি-২১ থেকে শুরু করে সর্বোচ্চ ২০টা মুভি। মানে, ১ম ২০টা মুভি এবার বাদ। পাবেন মুভি-২১ থেকে মুভি-৪০।
ইউজার ৩য় পেজে গেলে তখন আবার ডাটাবেস থেকে লোড করবেন মুভি-৪১ থেকে শুরু করে সর্বোচ্চ ২০টা মুভি। মানে, ১ম ৪০টা মুভি এবার বাদ। পাবেন মুভি-৪১ থেকে মুভি-৫৩।


এই ৩য় পেজের বেলাতেই, ডাটাবেস কুয়েরিটা হবে এমন,
```sql
select * from movies
LIMIT 20 OFFSET 40;
```

LIMIT মানে, সর্বোচ্চ কয়টা মুভির ডাটা চাচ্ছেন। OFFSET মানে, শুরু থেকে কয়টা বাদ দিয়ে এরপর আপনাকে দিবে।


হ্যাঁ, ২য় পেজের বেলাতে, কুয়েরিটা হবে এমন,
```sql
select * from movies
LIMIT 20 OFFSET 20;
```
...
হ্যাঁ, LIMIT ও OFFSET-এর ব্যবহার Pagination বা এমন ক্ষেত্রের জন্য।
